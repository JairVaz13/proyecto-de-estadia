let paginaActual = 1;
        ...
        async function obtenerEventos() {
            ...
            const response = await fetch(`http://localhost:8000/eventos?skip=${skip}&limit=${eventosPorPagina}`);
            ...
            eventos.forEach(evento => {
                ...
                eventoDiv.innerHTML = `
                    <div class="card-body">
                        ...
                        <p class="card-text">Ubicacion: <small class="text-muted">${evento.ubicacion}</small></p>
                    </div>
                `;
